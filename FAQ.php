...
<title>FAQs</title>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo URL ."public/css/style-FAQ.css"?>">
...
<header id="header">
        ...
        <nav class="nav-bar" id="navbar">
            <ul>
				...
				<li>
                    <a href="<?php echo URL ."/FAQ.php"?>">FAQs</a>
                </li>
                <li>
...
<div class="header1">
			...
			<div class="questions">
				...
				<h3><strong>Q1).What are the conditions treated by Expert Doctor?</strong></h3>
				<p>Ans:Expert Doctor treat conditions like headaches, flu, urinary infections, blood pressure, diabetes, common aches, etc.</p>
				<br />
				<h3><strong>Q2).Do Expert Doctor offer home consultation?</strong></h3>
				<p>Ans:Yes, most of the general Expert Doctor do offer home consultation in case of emergencies or when requested.</p>
  				<br />
				<h3><strong>Q3).Will the consultation and diagnosis be covered in insurance?</strong></h3>
				<p>Ans:Most of the conditions treated by Expert Doctor are common. Hence, most of them are not covered by insurance. However, you can always check with your insurance company.</p>
				<br />
				<h3><strong>Q4).Do Expert Doctor provide in-house medicines?</strong></h3>
				<p>Ans:Yes, some of the Expert Doctor do provide in-house medicines along with prescribing medication.</p>
				<br />
				<h3><strong>Q5).What are the consultation charges of Expert Doctor in Port said?</strong></h3>
				<p>Ans:The consultation fees of Expert Doctor in Dehradunranges approximately from  250 LE to  500 LE</p>
				<br />
				...
				<br />
				<h3><strong>Q7).How much does a Expert Doctor in Port said charge?</strong></h3>
				<p>Ans:A Expert Doctor charges approximately  400 LE to  500 LE per consultation.
				 (The prices are highly indicative and are subject to change.)</p>
				<br />
				<h3><strong>Q8).What is the procedure followed by Expert Doctor in Port said?</strong></h3>
				...
				<br />
				<h3><strong>Q9).What are the different diseases that can be treated by a Expert Doctor in Port said?</strong></h3>
				<p>Ans:Following diseases are be treated by Expert Doctor:
				<br />
				<ul>
